...
func (g *NonGatewayRouteController) reconcileRemoteSubnets(submNonGWRoute *submarinerv1.NonGatewayRoute, addSubnet bool) error {
	...
	isNextHopV6 := k8snet.IsIPv6String(nextHop)
	if isNextHopV6 != (g.ipFamily == k8snet.IPv6) {
		return nil
	}
	...
	logger.Warningf("The NonGatewayRoute is and subnet is  %v, %v", submNonGWRoute, g.remoteSubnets)
